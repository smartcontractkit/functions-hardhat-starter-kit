...
/**
 * @title Functions billing subscription registry interface.
 */
interface FunctionsRegistryInterface {
   ...
   */
  function getRequiredFee(bytes calldata data, FunctionsRegistryInterface.RequestBilling memory billing)
    external
    view
    returns (uint96);
   ...
   * @param gasLimit Encoded Functions request data, use FunctionsClient API to encode a request
   ...
   * @dev Only callable by an FunctionsOracle that has been approved on the Registry
   */
   ...
   * @dev Only callable by FunctionsOracles that have been approved on the Registry
