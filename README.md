...
| `functions-deploy-client`          | Deploys the FunctionsConsumer contract                                                                                        | `verify` (optional): Set to `true` to verify client contract (default: false)                                                                                                                                                                                                                                                                                                                                 |
...
| `functions-read`                   | Reads the latest response returned to a FunctionsConsumer or AutomatedFunctionsConsumer client contract                       | `contract`: Address of the client contract to read                                                                                                                                                                                                                                                                                                                                                            |
| `functions-read-error`             | Reads the latest error returned to a FunctionsConsumer or AutomatedFunctionsConsumer client contract                          | `contract`: Address of the client contract to read                                                                                                                                                                                                                                                                                                                                                            |
...
| `functions-deploy-auto-client`     | Deploys the AutomatedFunctionsConsumer contract using request data from `Functions-request-config.js`                         | `subid`: Billing subscription ID used to pay for Functions requests, `interval`: Update interval in seconds for Automation to call performUpkeep (default: 300), `gaslimit` (optional): Maximum amount of gas that can be used to call fulfillRequest in the client contract (defaults to 250,000 & must be less than 300,000), `verify` (optional): Set to `true` to verify client contract (default: false) |
