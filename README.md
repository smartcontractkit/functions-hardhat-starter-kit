...
| `functions-read`                   | Reads the latest response (or error) returned to a FunctionsConsumer client contract                                          | `network`: Name of blockchain network, `contract`: Address of the client contract to read                                                                                                                                                                                                                                                                                                                                  |
