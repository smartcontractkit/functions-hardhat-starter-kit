...
| `functions-simulate`               | Executes the JavaScript source code locally                                                    | `configpath` (optional): Path to request config file (defaults to `./Functions-request-config.js`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
