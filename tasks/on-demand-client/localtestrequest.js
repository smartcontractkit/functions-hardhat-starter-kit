...
task('on-demand-local-test', 'Calls an On Demand API consumer contract to request external data')
                    ...
                    try {
                        ...
                        console.log(
                            `Total cost: ${hre.ethers.utils.formatUnits(
                                totalCost,
                                18
                            )} LINK which is equal to $${hre.ethers.utils.formatUnits(totalCost.mul(answer), 26)}\n`
                        )
                    } catch {}
                    return resolve()
                })
